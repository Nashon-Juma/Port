...
(function ($) {
    ...
    // 23. ux strategy
    if (device_width > 1200) {
        var workflow_section_3 = document.querySelector(".ux-strategy");
        if (workflow_section_3) {
            let duration = 1,
                sections = gsap.utils.toArray(".ux-strategy_panel"),
                sectionIncrement = duration / (sections.length - 1),
                tl = gsap.timeline({
                    scrollTrigger: {
                        trigger: ".ux-strategy",
    ...
    // 23. ui strategy
    if (device_width > 1200) {
        var workflow_section_3 = document.querySelector(".ui-strategy");
        if (workflow_section_3) {
            let duration = 1,
                sections = gsap.utils.toArray(".ui-strategy_panel"),
                sectionIncrement = duration / (sections.length - 1),
                tl = gsap.timeline({
                    scrollTrigger: {
                        trigger: ".ui-strategy",
